...
In conclusion, our game design project was an overall success, marked by a strong sense of teamwork, effective communication, and valuable learning experiences. The project's achievements can be attributed to the diverse skill set of our team and our general adaptability. We made consistent progress throughout this project, adapting to ongoing design decisions and working in iterative cycles.

This project introduced us to agile development methods, which proved to be invaluable for team collaboration. The implementation of agile methodologies, such as sprints and Kanban boards greatly influenced our workflow. They encouraged frequent team communication and clear ownership of tasks, both significantly enhanced our team's efficiency and organisation.
